...
RandomUserAdapter randomeUser = new RandomUserAdapter();
var users = await randomeUser.GetAllUsers();

PlaceholderUserAdapter placeholderUserAdapter = new PlaceholderUserAdapter();
users.AddRange(await placeholderUserAdapter.GetAllUsers());
